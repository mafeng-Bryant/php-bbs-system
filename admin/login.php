...
if (is_manage_login($link)){
    skipPage('index.php','ok','你已经登录，请不要重复登录!');
}
...
if (isset($_POST['submit'])){
    ...
    $query = "select * from sfk_manage where name = '{$_POST['name']}' and password = md5('{$_POST['password']}')";
    ...
    if (mysqli_num_rows($result) ==1){
        ...
        skipPage('login.php','error','用户名或者密码错误!');
    }
...
<div id="main">
    ...
    <form method="post">
        ...
        <label>密　码：<input class="text" type="password" name="password" /></label>
